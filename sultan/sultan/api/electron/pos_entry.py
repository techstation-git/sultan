...
from sultan.sultan.api.electron.cache import clear_backend_cache
from sultan.sultan.api.electron.sales_invoice import delete_draft_invoices_for_opening_entry
...
def create_closing_entry():
	...
	try:
		...
		try:
			from sultan.sultan.api.electron.cash_transaction import create_gl_entries_for_session
